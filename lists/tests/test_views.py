...
# TODO create class for new_list view
...
class ListViewTest(TestCase):
    ...
    def test_invalid_input_renders_home_page_template(self):
        response = self.client.post('/lists/new', data={'text': ''}) # TODO Remove hardcoded URLs from views.py
    ...
    def test_validation_errors_end_up_on_page(self):
        response = self.post_invalid_input()
        self.assertContains(response, escape(EMPTY_ITEM_ERROR))
